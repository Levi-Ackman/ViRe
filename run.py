...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="ViRe")
    parser.add_argument(
        "--model",
        type=str,
        required=True,
    ...
    parser.add_argument("--c_layer", type=int, default=6, help="num of encoder layers for channel")
    parser.add_argument("--t_layer", type=int, default=6, help="num of encoder layers for temporal")
    parser.add_argument("--llm_layer", type=int, default=2, help="num of encoder layers for LLM embeddings")
    ...
    for ii in range(args.itr):
            ...
            setting = "{}_{}_seed_{}_dm_{}_dp_{}_tl_{}_cl_{}_bs_{}_lr{}_aug_{}_pl_{}".format(
                args.model,
                args.data,
                args.seed,
                args.d_model,
